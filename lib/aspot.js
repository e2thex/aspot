...
aspot.localDB = function(store) {
 ...
 that.retrieve = function(request) {
   ...
   return items
     ...
     .map(function(value) {return db.datum(value)});
 }
 return that;
