// import { defaultMatchContext, isTrue } from '../match';
...
// import { Match, MatchContext, Sentence, Term, TermType, GroupSentences, WhereMatch } from '../types';
...
//   });
//   it('also should add the default context if not context is passed', () => {
//     expect(addContextResult()({}).context()).toStrictEqual(defaultMatchContext());
