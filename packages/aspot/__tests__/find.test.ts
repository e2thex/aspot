...
import { defaultMatchContext, isTrue, subjectIs } from '../lib/match';
import { MatchContext, Sentence, TermType } from '../lib/types';
...
describe('groupSentences', () => {
    ...
    expect(groupSentences(sentences)(TermType.subject)).toStrictEqual({
      a:[
        {subject:'a', predicate:'b', object:'c', date:0},
        {subject:'a', predicate:'bx', object:'cx', date:0},
      ],
